...
class WebWeixin(object):
    ...
    def handleMsg(self, r):
        for msg in r['AddMsgList']:
            ...
            if msgType == 51:
                ...
                logging.info('%s 给你发送了一段语音: %s' % (name, voice))
                ...
                if content.find('red packet'):
                    print '%s 发来红包,请在手机上查看' % name
                else:
    ...
    def start(self):
        ...
        self._echo('[*] 共有 %d 位联系人' % len(self.ContactList))
        print
        logging.debug('[*] 共有 %d 位联系人' % len(self.ContactList))
...
if __name__ == '__main__':
    ...
    try:
        ...
        print 'WARN: No coloredlogs module found!'
